...
namespace TsiWebApp.Controllers
{
    public class TimeSeriesDataController : Controller
    {
        ...
        public async Task<IActionResult> Index(
            ...
            int width = 350,
            int height = 205,
            InterpolationFunction interpolation = InterpolationFunction.none)
        {
            try
            {
                ...
                ViewData["InterpolationFunction"] = interpolation == InterpolationFunction.none ? "" : interpolation.ToString();
